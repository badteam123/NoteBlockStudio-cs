...
namespace NoteBlockStudioCS {
    public partial class Form1: Form {
        ...
        public Form1() {
            ...
            mixer.AddMixerInput(new ConcatenatingSampleProvider(sources));
        ...
        private void Form1_DragDrop(object sender, DragEventArgs e) {
            ...
            if (files.Length == 1) {
                ...
                Console.WriteLine(loader.MinutesSpent);
        ...
        private void btnPlay_Click(object sender, EventArgs e) {
            ...
            //var soundSource = CodecFactory.Instance.GetCodec("stuff/sounds/harp.wav");
        ...
        private void picBox_Paint(object sender, PaintEventArgs e) {
            ...
            foreach (int x in notes.Keys) {
                foreach (int y in notes[x].Keys) {
                    g.FillRectangle(temp, (notes[x][y].X - offset) * 32, (notes[x][y].Y+1) * 32, 32, 32);
